...
@class ZNWaterfallLayout;

@protocol ZNWaterfallLayoutDelegate <NSObject>
 ...
 */
@interface ZNWaterfallLayout : UICollectionViewLayout
...
//代理，用来计算item的高度
@property (nonatomic, weak) id<ZNWaterfallLayoutDelegate> delegate;
