...
-(void)initButtons{
    if (self.buttonTitleArray.count > 0) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            [button setBackgroundImage:[UIImage imageWithColor:HEX_COLOR(0xededed) size:button.size] forState:UIControlStateHighlighted];
...
-(void)initCancelButton{
    if (self.cancelButtonTitle!= nil) {
        ...
        [self.cancelButton setBackgroundImage:[UIImage imageWithColor:HEX_COLOR(0xededed) size:_cancelButton.size] forState:UIControlStateHighlighted];
